    ...
    <div className="card p-4">
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_220px]">
        ...
        <div className="grid gap-3 text-sm">
          ...
          <Toggle label="Deskew" help="Auto-straighten a tilted scan (±15°)" checked={!!value.deskew} onChange={(v) => update({ deskew: v })} />
          <Toggle label="Auto-crop" help="Trim dark scanner border / shadow" checked={!!value.autoCrop} onChange={(v) => update({ autoCrop: v })} />
          <Toggle label="Adaptive B/W" help="Local threshold for shaded scans" checked={!!value.adaptiveThreshold} onChange={(v) => update({ adaptiveThreshold: v })} />
