...
export function useHistory() {
  ...
  // Refresh once the IndexedDB-backed cache finishes its async hydration
  // (the initial useState() read happens before hydration completes).
  useEffect(() => onHistoryReady(refresh), [refresh]);
