...
const STRINGS: Record<string, { en: string; km: string }> = {
  ...
  'tab.metadata': { en: 'Metadata', km: 'មេតាដេតា' },
  'tab.metadata.hint': { en: 'Extraction records & edits', km: 'ទិន្នន័យស្រង់ និងកែប្រែ' },
  ...
  'short.metadata': { en: 'Metadata', km: 'មេតាដេតា' },
  ...
  // Region reader — "crop & read a specific part", available on every page image.
  'region.button': { en: 'Read area', km: 'អានតំបន់' },
  'region.title': { en: 'Read a specific area', km: 'អានតំបន់ជាក់លាក់' },
  'region.hint': { en: 'Drag a box over the part you want to read.', km: 'អូសប្រអប់លើផ្នែកដែលអ្នកចង់អាន។' },
  'region.run': { en: 'Read this area', km: 'អានតំបន់នេះ' },
  'region.running': { en: 'Reading…', km: 'កំពុងអាន…' },
  'region.clear': { en: 'Clear', km: 'សម្អាត' },
  'region.close': { en: 'Close', km: 'បិទ' },
  'region.loading': { en: 'Loading image…', km: 'កំពុងផ្ទុករូបភាព…' },
  'region.result': { en: 'Result', km: 'លទ្ធផល' },
  'region.copy': { en: 'Copy', km: 'ចម្លង' },
  'region.noText': { en: '(no text found)', km: '(រកមិនឃើញអត្ថបទ)' },
