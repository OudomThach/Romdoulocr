...
import { copyToClipboard, downloadText, isPdf } from '@/lib/utils';
            ...
            <header className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={() => {
                    downloadText(`${sanitizeFilename((currentResult.filename ?? 'ocr').replace(/\.[^.]+$/, ''))}.txt`, cleanText);
                  }}
...
function DownloadIcon({ className }: { className?: string }) {
  return <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 3v11" strokeLinecap="round" /><path d="m8 10 4 4 4-4" strokeLinecap="round" strokeLinejoin="round" /><path d="M5 19h14" strokeLinecap="round" /></svg>;
}
